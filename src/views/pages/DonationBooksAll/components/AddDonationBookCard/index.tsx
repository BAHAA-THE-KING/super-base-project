...
const i18ns = ["add_new_donation_book"];
export function AddDonationBookCard() {
  const [AddNewDonationBookText] = useBaseTranslation(i18ns);
  return (
    <Link to={"add"}>
      <BCard
        sx={{
      ...
      >
        ...
        <CardContent>
          <BTypography>{AddNewDonationBookText}</BTypography>
        </CardContent>
      </BCard>
    </Link>
  );
